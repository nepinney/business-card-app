...
import { RootStackScreenProps, SelectionFields } from '../../../types';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        <CustomSelect label="PHONE 1" isSelected={isLabelSelected('phone1')} setIsSelected={() => setFieldIsSelected('phone1')} />
        <CustomSelect label="PHONE 2" isSelected={isLabelSelected('phone2')} setIsSelected={() => setFieldIsSelected('phone2')} />
        ...
        <CustomSelect label="FACEBOOK PAGE" isSelected={isLabelSelected('facebook')} setIsSelected={() => setFieldIsSelected('facebook')} />
      </View>
